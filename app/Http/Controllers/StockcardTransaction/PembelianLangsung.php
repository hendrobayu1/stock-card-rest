...
class PembelianLangsung extends Controller
{
    ...
    public function listPembelianLangsung(Request $request){
        ...
        if($user && $user->id != 353){
            ...
            $code = 200;
            $status = 'success';
            $message = 'data pembelian langsung';
        }else{
    ...
    public function cariPembelianLangsungperKode(Request $request){
        $depo = $request->depo;
        ...
        if($user && $user->id != 353){
            ...
            if($kode_transaksi!=''){
                ...
                if($jumlah_data>0){
                    ...
                    $message = 'transaksi ini tidak ditemukan';
                }
            }else{
                //cek nomor & tgl DKO
                $jumlah_data =  DB::table('if_htrans as a')
            ...
            if($message==''){
                ...
                $message = 'data transaksi pembelian langsung';
                $code = 200;
                $status = 'success';
        ...
        $this->logUser($user->id,'/transaksi','proses pembelian langsung kartu stok',json_encode($request->all()),$message,$device_info);
